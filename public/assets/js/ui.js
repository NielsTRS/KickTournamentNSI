...
function menuUi(){
	if(!menuOpened){ //Ouverture du menu
		...
		effectDown.mousePressed(function(){changeEffectVolume(-0.1)})
		...
		effectUp = createDiv('>')
		effectUp.mousePressed(function(){changeEffectVolume(0.1)})
		...
		if(player.death()){
			...
			replay.mousePressed(function(){
				menuUi();
				d = undefined;
				try{deathText.remove()}catch(err){}
